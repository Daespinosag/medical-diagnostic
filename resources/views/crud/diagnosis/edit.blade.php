...
@section('headerCard')
    <div class="card-head">
        <header class="text-primary-dark">{{ trans('global.diagnosis.title.edit') }}</header>
    </div>
@endsection
...
@section('bodyCard')
    ...
    <div class="col-lg-8 col-lg-offset-2">
        {!! Form::model($diagnosis,['route'=> ['admin.diagnosis.update',$diagnosis],'method'=> 'PUT', 'class'=> 'form-horizontal form-validate floating-label', 'novalidate'=>'novalidate']) !!}
