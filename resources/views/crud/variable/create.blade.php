...
@section('headerCard')
    <div class="card-head">
        <header class="text-primary-dark">{{ trans('global.variable.title.create') }}</header>
    </div>
@endsection
...
@section('bodyCard')
    ...
    <div class="col-lg-8 col-lg-offset-2">
        {!! Form::open(['route'=> 'admin.variable.store','method'=> 'POST', 'class'=> 'form-horizontal form-validate floating-label', 'novalidate'=>'novalidate']) !!}
