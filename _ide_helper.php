 ...
 * Generated for Laravel 5.4.36 on 2017-09-27.
 *
...
namespace App\Facades { 
    ...
    class OfiClinicFacade {
         ...
         * @static 
         */ 
        public static function getPatientMedicalHistory($patientIdNumber)
        {
            return \App\Soap\OfiClinicDataRecovery::getPatientMedicalHistory($patientIdNumber);
        }
         ...
         * @static 
         */ 
        public static function findPatientLocalValue($patientIdNumber, $jsonVariableName, $case)
        {
            return \App\Soap\OfiClinicDataRecovery::findPatientLocalValue($patientIdNumber, $jsonVariableName, $case);
        }
